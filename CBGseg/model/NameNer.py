...
import os
sys.path.append('..')
from utils.dataset import read_dataset2
from collections import Counter

DATA_DIR = os.getcwd() + '/../train/data/'
PDict = DATA_DIR + 'person.txt'
...
class CNNAME(object):
    ...
    def fit(self):
        ...
        self.distribute = [0.1799, 0.7402, 0.0575]      #姓名概率分布
        self.Pre_Postdict = {}
        self.contextsum = 0
        dump_data = []
        self.load_dict()
                ...
                while index < len(sen):
                    ...
                    if (tag1 == 'nr'):
                        ...
                        for chr in word1:
                            self.character.update(chr)
                    index += 1
            f1 = open('../train/data/cn_name.txt', 'rb')
            f2 = open('../train/data/cn_namelist.utf8', 'wb')
            i = 0
            double = 0
            tri = 0
            fourth = 0
